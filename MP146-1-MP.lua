...
filename = "MP146-1.txt"	--here we save the table of integrals

NumSpectra = 45	-- number of points for the kinetic study
...
dx = 0.25	-- (constant) region to zoom in, in ppm units, based upon experience and observation
