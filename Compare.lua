...
HOME = HOME or "/Users/juergen/Desktop/"		 -- define here your home directory
						-- never forget the initial slash !
filename = "compare.txt"	--here we save the table of integrals
...
dx = 0.05	-- (constant) region to zoom in, in ppm units, based upon experience and observation
